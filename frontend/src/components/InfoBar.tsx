...
{
        return (
                <header className="absolute z-1 text-white w-screen p-5 font-bold bg-white/30 backdrop-blur-sm">
                        <div className="float-left">204 España y Rivadavia, Formosa Capital</div>
                        <div className="flex float-right [&_:is(div)]:pr-5" contentEditable>
                                <div className="flex">
